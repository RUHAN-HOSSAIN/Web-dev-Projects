...
const Navbar = ({ theme, setTheme }) => {
  ...
  return (
    ...
    >
        ...
        <img src={assets.close_icon} className='w-5  absolute right-4 top-6 sm:hidden' onClick={() => {setSidebarOpen(false)}} alt='' />
      ...
      <div className='flex items-center gap-2 sm:gap-4'>
        ...
        <img src={theme === 'dark' ? assets.menu_icon_dark : assets.menu_icon} className="w-8 sm:hidden" onClick={() => {setSidebarOpen(true)}} alt="" />
